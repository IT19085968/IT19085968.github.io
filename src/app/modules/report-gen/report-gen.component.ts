...
export class ReportGenComponent implements OnInit, OnDestroy {
  ...
  getReport(e: any): void {
    if (!this.formValidation()) {
      ...
      if (this.reportT === '3') {
        const reports: any[] = [];
        const pumpReport$: Observable<any> = this.reportsService.getPumps(
          filter.FromDate,
          filter.ToDate
        );
        reports.push(pumpReport$);
        const terminalReport$: Observable<any> =
          this.reportsService.getTerminals(filter.FromDate, filter.ToDate);
        reports.push(terminalReport$);

        const subscription: any = forkJoin(reports).subscribe(
          (responses: any[]) => {
        ...
        content: [
          ...
          },
          {
            table: {
              ...
              body: [
                [
                  { text: 'Receipt#', border: [false, false, false, true] },
                  { text: 'Date', border: [false, false, false, true] },
                  { text: 'Time', border: [false, false, false, true] },
                  { text: 'Pump', border: [false, false, false, true] },
                  { text: 'Blend', border: [false, false, false, true] },
                  {
                    text: 'Quantity(Ltrs)',
                    border: [false, false, false, true],
                  },
                  { text: 'UnitPrice', border: [false, false, false, true] },
                  { text: 'Amount', border: [false, false, false, true] },
                  { text: 'Pay Mode', border: [false, false, false, true] },
                ],
                ...this.sales.map((p: any) => [
                  ...
                  {
                    text: moment(new Date(p.dDate)).format('YYYY/MM/DD'),
                    border: [false, false, false, false],
                  },
                  { text: p.dTime, border: [false, false, false, false] },
                  { text: p.pumpID, border: [false, false, false, false] },
                  { text: p.productName, border: [false, false, false, false] },
                  {
                    text: parseFloat(p.quantity).toFixed(2),
                    border: [false, false, false, false],
                  },
                  {
                ...
                [
                  ...
                  { text: '', border: [false, true, false, true] },
                  {
                    text: this.sales
                      .reduce(
                        (sum: any, p: any) => sum + parseFloat(p.quantity),
                        0
                      )
                      .toFixed(2),
                    border: [false, true, false, true],
            ...
            table: {
              ...
              body: [
                [
                  ...
                  {
                    text: 'Electronic Totals',
                    border: [true, true, true, true],
                    colSpan: 2,
                  },
                  { text: '', border: [true, true, true, true] },
                  {
                    text: 'Delivery Totals',
                    border: [true, true, true, true],
                    colSpan: 2,
                  },
                  { text: '', border: [true, true, true, true] },
                ...
                ...this.sales.map((p: any) => [
                  ...
                  {
                    text: parseFloat(p.electronicTotalQty).toFixed(2),
                  ...
                  {
                    text: parseFloat(p.deliveryTotalQty).toFixed(2),
                    border: [true, true, true, true],
                  },
                  {
  ...
  formValidation(): boolean {
    ...
    fromDate = this.reportsFormGroup?.value.FromDate
      ? moment(this.reportsFormGroup?.value.FromDate).format('YYYY-MM-DD')
      : null;
    toDate = this.reportsFormGroup?.value.ToDate
      ? moment(this.reportsFormGroup?.value.ToDate).format('YYYY-MM-DD')
      : null;
